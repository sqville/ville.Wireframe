...
qx.Class.define("widgetbrowser.pages.ToolBar",
{
  ...
  members :
  {
    ...
    initWidgets: function()
    {
      ...
      this.add(this.getToolBar(), {left: 0, top: 40});

      // Menu (with slidebar)
      this.add(this.getMenuWithSlideBar(), {left: 0, top: 115});

      // MenuBar
      label = new qx.ui.basic.Label("MenuBar & Menu");
      this.add(label, {left: 0, top: 250});
      this.add(this.getMenuBar(), {left: 0, top: 270});

      // Toolbar for exclude
      label = new qx.ui.basic.Label("ToolBar Part (Button, CheckBox, RadioButton, MenuButton)");
      this.add(label, {left: 0, top: 330});
      this.add(this.getToolBarExclude(), {left: 0, top: 350});

      // Context menu
      label = new qx.ui.basic.Label("Context Menu (Right click the widget)");
      this.add(label, {left: 0, top: 420});
      this.add(this.getContextMenuWidget(), {left: 0, top: 440});
